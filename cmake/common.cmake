...
elseif(CMAKE_BUILD_TYPE STREQUAL Bridges_GPROF)
  ...
  message("-- ${CMAKE_CURRENT_SOURCE_DIR} > Bridges_GPROF uninstructed build")
  set(CMAKE_C_FLAGS "-O3 -pg" CACHE STRING "cflags")
  set(CMAKE_CXX_FLAGS "-O3 -pg" CACHE STRING "cxxflags")
  set(PAPI_ROOT $ENV{PAPI_DIR})
